...
If you want the full technical detail, it's in the [project README](https://github.com/sambt94/remarkable-mcp).

![Handwritten reMarkable notes](/images/writing/remarkable-page-53.png)

In fact, the first draft of this article started life as scribbled notes on my reMarkable. It went through the same pipeline — rendered, transcribed, saved as a Markdown file — and then I continued editing from there.
