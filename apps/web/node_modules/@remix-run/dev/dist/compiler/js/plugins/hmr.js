...
declare global {
  interface Window {
    __hmr__: any;
      ...
      let remixReactPath = require.resolve("@remix-run/react/dist/esm/browser.js", {
      ...
      build.onLoad({
        ...
        if (args.path !== remixReactPath && !args.path.match(/@remix-run[/\\]react[/\\]dist[/\\]esm[/\\]browser.js$/) && !args.path.match(/react-router[-dom]?[/\\]$/) && (!args.path.match(/\.[tj]sx?$/) || !fs__namespace.existsSync(args.path) || !args.path.startsWith(config.appDirectory))) {
          return undefined;
        }
