    ...
    plugins: [{
      ...
      setup(build) {
        ...
        build.onLoad({
          ...
          if (theExports.includes("loader") && theExports.includes("clientLoader")) {
            contents = `export { loader, clientLoader } from ${JSON.stringify(`./${file}`)};`;
            ...
            contents = `export { clientLoader } from ${JSON.stringify(`./${file}`)};`;
          }
          return {
            contents,
